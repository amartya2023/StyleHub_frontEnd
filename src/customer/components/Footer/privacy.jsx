      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            ...
            this Agreement) refers to stylehub-fasion.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to stylehub-fasion, accessible from{" "}
            <a
              href="https://stylehub-fasion.netlify.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://stylehub-fasion.netlify.app/
            </a>
          </li>
          <li>
        ...
        <h4 className="text-xl font-bold mb-4">Personal Data</h4>
        <p className="mb-2">
        ...
        <h4 className="text-xl font-bold mb-4">Usage Data</h4>
        <p className="mb-4">
        ...
        <h3 className="text-2xl font-bold mb-4">Delete Your Personal Data</h3>
        <p className="mb-4">
        ...
        <h4 className="text-xl font-bold mb-4">Business Transactions</h4>
        <p className="mb-4">
        ...
        <h4 className="text-xl font-bold mb-4">Law enforcement</h4>
        <p className="mb-4">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="text-xl font-bold mb-4">Other legal requirements</h4>
        <p className="mb-2">
