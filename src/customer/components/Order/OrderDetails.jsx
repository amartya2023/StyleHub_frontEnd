            ...
            {[1,1,1,1,1].map((item)=><Grid item container className='shadow-xl rounded-md p-5 border' sx={{alignItems:"center", justifyContent:"space-between"}}>
                ...
                <Grid item xs={6}>
                    ...
                    <div className='flex items-center space-x-4'>
                        <img className='w-[5rem] h-[5rem] object-cover object-top' src="https://rukminim2.flixcart.com/image/416/416/xif0q/cargo/j/p/5/30-black-cargo-x2-nayak-fashion-original-imagtbhuthbgngzs.jpeg?q=70&crop=true" alt="" />
